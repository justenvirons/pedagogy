...
The "ggplot" package can be used not only to create a variety of data plots but also maps. In this section, the package is used to create single variable (i.e., univariate) and two variable (i.e., bivariate) maps.
