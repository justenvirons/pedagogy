...
st_write(places_svi_tracts_county_sub_geom, "layers/places_svi_tracts_county_sub_geom.shp", append = FALSE)
st_write(county_boundary_geom, "layers/county_boundary_geom.shp", append = FALSE)
```
...
![Bivariate Correlation Plot](images/corr-plot-sample-01.png){#fig-bivariate-sample-01}

![Bivariate Correlation Plot](images/corr-plot-sample-02.png){#fig-bivariate-sample-02}
