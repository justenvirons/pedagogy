...
save(us_counties_geom,
     B01001_2020,
     tract_boundaries_geom,
     places_2021_tracts_all,
     places_2021_tracts_sel_geom,
     svi_2018_tracts_all,
     svi_data_dicionary,
     file="exercise_01_comprehensive.RData")
...
places_202_tracts_all <- read_csv("https://chronicdata.cdc.gov/api/views/cwsq-ngmh/rows.csv?accessType=DOWNLOAD&bom=true&format=true")
...
save(svi_2018_tracts_all, places_2021_tracts_all, file="GEO346_2022_FallQuarter/Exercise_01/data/svi_places.RData")
